function [fitresult, gof] = fit_acf_2exp(lag, acf)
...
% legend( h, 'acf vs. lag', 'weighted sum of exponential fit', 'Location', 'NorthEast', 'Interpreter', 'none' );
% % Label axes
% xlabel( 'lag [s]', 'Interpreter', 'none' ,'FontSize', 16);
% ylabel( 'ACF', 'Interpreter', 'none','FontSize', 16 );
