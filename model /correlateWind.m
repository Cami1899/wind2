...
ascentPMag1 = syncPMag1(ascentPeriod1); %Absolute Dynamic Pressure Magnitude, Flight 1
ascentPMag2 = syncPMag2(ascentPeriod2);
avgPMag1 = zeros(size(ascentPMag1)); %Rolling Average Dynamic Pressure Magnitude, Flight 1
avgPMag2 = zeros(size(ascentPMag2));

windowSize = 100; %100 datapoints either side corresponds to 5 seconds
