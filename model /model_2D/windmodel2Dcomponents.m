...
load('wind_matrix_components1.mat')
load('wind_matrix_components2.mat')

        % %Flight1 
        
        wind_speed1=wind_matrix_components_1(:,2:3);
        time1=wind_matrix_components_1(:,1);
        
        % %Flight2
        wind_speed2=wind_matrix_components_2(:,2:3); 
        time2=wind_matrix_components_2(:,1);
...
if choice_flight==1
    ...
    % %Flight2
        ...
        %index (1:35923)=0-20 mim
        %index (89806:107767)=50-60 min
        wind_speed=wind_speed2;
        time=time2;
end

%Choose between wind data on x axis and y axis

choice_axis=input('Which components? (Digit 1 for x axis or 2 for y axis) ')
if choice_axis==1
...
figure
plot(time-time(1),wind_speed)
hold on 
xlim([0,2000])
title('Wind speed signal from flight test', 'FontSize', 16 )
...
% maxLag=100;
maxLag=choice_nLag;
[acf,lag]=autocorr(wind_speed(:,1),maxLag); 
...
%  
%     save('f2_coef_lag100_res1_y',"coef")
%     save('f2_fit_lag100_res1_y',"fit_function")
%     save('f2_ncomp_lag100_res1_y',"num_comp")

%1.2. b)Load a fit

%Flight 1 

% This data are for wind_speed  resample 1 lag 100, x axis;

load('f1_coef_lag100_res1_x.mat')
load('f1_fit_lag100_res1_x.mat')
load('f1_ncomp_lag100_res1_x.mat')

%This data are for wind_speed  resample 1 lag 100, y axis;
% load('f1_coef_lag100_res1_y.mat')
% load('f1_fit_lag100_res1_y.mat')
% load('f1_ncomp_lag100_res1_y.mat')
...
%Flight 2 
%%This data are for wind_speed on x axis (1:3593)=2min, resample 1, lag 100;
% load('f2_coef_2min_lag100_res1_x.mat')
% load('f2_fit_10min_lag100_res1_x.mat')
% load('f2_ncomp_2min_lag100_res1_x.mat')
...
%This data are for wind_speed  resample 1 lag 100, y axis;
% load('f2_coef_lag100_res1_y.mat')
% load('f2_fit_lag100_res1_y.mat')
% load('f2_ncomp_lag100_res1_y.mat')
...
x0=4*wind_speed(1);  %mean_value; %x initial point
y0=wind_speed(1);   %mean_value; %y initial poin
T= 20000; %time interval
dt=0.001; %integration steps
