...
% 
%     save('f2_coef_10min_lag100_res1',"coef")
%     save('f2_fit_10min_lag100_res1',"fit_function")
%     save('f2_ncomp_10min_lag100_res1',"num_comp")
...
x0=wind_speed(1);  %mean_value; %x initial point
...
[ecdf,x_ecdf]=ecdf(VIRAwind(:,1)); %Use the Kaplan-Meier estimator to estiamte ecdf
...
grid('on');
subplot(2, 1, 2);
histogram(VIRAwind(:,1), 100,'Normalization', 'pdf', 'EdgeColor', 'none');
xlabel('v [m/s]', 'FontSize', 16)
ylabel('PDF', 'FontSize', 16, 'Rotation', 0, 'HorizontalAlignment', 'right')
