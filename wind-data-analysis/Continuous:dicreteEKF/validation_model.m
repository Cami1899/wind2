...
lambda=0.3 %0.15;    %linear coffcient of evolution of absolute vertical wind on gondola 
sigma=0;
...
[t,s]=ode113(@(t,s) model_function(s,C_D_B,S_BCM,C_D_G,S_G,rho_gas,VolB,g,k,c,l_t,m_G,m_BCM,lambda,sigma,v_ref,z_ref),[1:dt:1000],s(:,1),options);
s=s';
